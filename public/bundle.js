...
function makeStateWithLocation(state, location) {
  if ("none" !== 'production' && _deprecateObjectProperties.canUseMembrane) {
...
function withRouter(WrappedComponent, options) {
  ...
  var WithRouter = _react2.default.createClass({
    ...
    getWrappedInstance: function getWrappedInstance() {
      !withRef ?  true ? (0, _invariant2.default)(false, 'To access the wrapped instance, you need to specify ' + '`{ withRef: true }` as the second argument of the withRouter() call.') : undefined : void 0;
...
exports.default = function () {
  ...
  if (true) {
    middlewares.forEach(function (middleware, index) {
       true ? (0, _routerWarning2.default)(middleware.renderRouterContext || middleware.renderRouteComponent, 'The middleware specified at index ' + index + ' does not appear to be ' + 'a valid React Router middleware.') : undefined;
    });
  }
...
var MovieList = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            "div",
            { className: "container" },
            React.createElement("section", { className: "movies" })
        );
    }
});
...
/* harmony import */ var symbol_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(227);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(230);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(228), __webpack_require__(229)(module)))
